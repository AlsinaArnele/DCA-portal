...
<html lang="en">
    ...
    <body>
        ...
        <h1>Please Enter Activation Code</h1>
        <form action="actions/verify.php" method="post" class="main" id="verificationForm">
            <input type="text" name="one" oninput="moveToNext(this, 'two')">
